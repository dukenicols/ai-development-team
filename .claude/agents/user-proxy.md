...
2. Check `communication/domains/` for existing context
3. If requirements are unclear, list clarifying questions
4. Once clear, create a structured requirements summary
5. Invoke the `project-manager` agent with the requirements via Task tool

## Communication
- Write requirements to `communication/messages/` using the message template
- Always include: user story, acceptance criteria, affected domains
- Use the helper scripts: `./scripts/create-message.sh user-proxy project-manager requirements`
